...
BACKEND_URL     = "https://nonconciliating-glenna-unstaidly.ngrok-free.dev"
...
<div id="hw-retry-banner" style="display:none;background:rgba(96,165,250,0.07);
    ...
    <button onclick="hwResume()" style="background:#2563EB;color:white;border:none;
...
<div style="display:flex;gap:10px;margin-bottom:14px;">
    <button id="hw-start" onclick="hwStart()" style="flex:1;border:none;padding:14px;
    ...
    <button id="hw-stop" onclick="hwStop()" disabled style="flex:1;border:none;padding:14px;
...
window.hwStart  = hwStart;
window.hwStop   = hwStop;
window.hwResume = hwResume;
